...
sales_fig.update_layout(plot_bgcolor="#F0F0F0", title_font=dict(size=20))
...
segmentation_fig.update_layout(title_font=dict(size=20))
...
product_fig.update_layout(plot_bgcolor="#F0F0F0", title_font=dict(size=20))
